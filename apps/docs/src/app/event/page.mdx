  ...
  <div className="flex items-start gap-3">
    ...
    <div>
      <div className="font-semibold text-purple-900 dark:text-purple-100 mb-2">
        Event는 DataGSM 웹 콘솔에서 관리합니다
      </div>
      <div className="text-purple-800 dark:text-purple-200 text-sm">
        Event 등록·조회·수정·삭제는 DataGSM 웹에 로그인한 뒤 Event 페이지에서 수행합니다. API Key(OpenAPI)나 OAuth Access Token으로 호출하는 별도의 공개 관리 API는 제공되지 않습니다. 콘솔 사용 방법은 <a href="/event/console">웹 콘솔에서 관리</a> 문서를 참고하세요.
      </div>
    </div>
  </div>
</div>
